...
mod test {
    ...
    #[test]
    fn test_sha512_output_conversions() {
        let array = [1u8; 64];
        let output = Sha512Output::from(array);
    ...
    fn test_reset_functionality() {
        ...
        let default_hasher = Sha512::default();
    ...
    fn test_output_zeroize() {
        let mut output = Sha512Output::from([42u8; 64]);
        output.zeroize();
        assert_eq!(output.as_ref(), &[0u8; 64]);
    }
